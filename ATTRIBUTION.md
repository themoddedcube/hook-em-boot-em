...
|---|---|---|---|
| `assets/models/6502.glb` | Blender (parametric) | project asset | KIM-1-style 6502 board authored parametrically per PRD §4. (fal.ai material pass pending account top-up.) |
